            ...
            Drawing.OnDraw += args =>
                {
                    ...
                    if (BoolLinks["drawPercentage"].Value)
                    {
                        ...
                        {
                            var currentPercentage = this.GetCustomDamage(source) * 100 / source.Health;
                    ...
                    if (BoolLinks["drawJunglePercentage"].Value)
                    {
                        ...
                        {
                            var currentPercentage = this.GetCustomDamage(jungleMobs) * 100 / jungleMobs.Health;
                            var updatedCurrentPercentage = (int)Math.Ceiling(currentPercentage);
                            ...
                            if (updatedCurrentPercentage >= 0)
                            {
                                ...
                                {
                                    case "SRU_Razorbeak":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X + 50, jungleMobs.HPBarPosition.Y, Color.GreenYellow,
                                            string.Format("{0}%", updatedCurrentPercentage));
                                        break;
                                    case "SRU_Red":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X, jungleMobs.HPBarPosition.Y - 3, Color.GreenYellow,
                                            string.Format("{0}%", updatedCurrentPercentage));
                                        break;
                                    case "SRU_Blue":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X, jungleMobs.HPBarPosition.Y, Color.GreenYellow,
                                            string.Format("{0}%", updatedCurrentPercentage));
                                        break;
                                    case "SRU_Dragon":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X, jungleMobs.HPBarPosition.Y, Color.GreenYellow,
                                    ...
                                    case "SRU_Gromp":
                                        ...
                                        break;
                                    case "SRU_Krug":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X + 53, jungleMobs.HPBarPosition.Y, Color.GreenYellow,
                                            string.Format("{0}%", updatedCurrentPercentage));
                                        break;
                                    case "SRU_Murkwolf":
                                        Drawing.DrawText(jungleMobs.HPBarPosition.X + 50, jungleMobs.HPBarPosition.Y, Color.GreenYellow,
